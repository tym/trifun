...
if ( !class_exists( 'YITH_WCPB_Frontend_Premium' ) ) {
    ...
    class YITH_WCPB_Frontend_Premium extends YITH_WCPB_Frontend {
        ...
        public function __construct() {
            ...
            add_filter( 'woocommerce_order_item_visible', array( $this, 'woocommerce_order_item_visible' ), 10, 2 );
        ...
        public function woocommerce_check_cart_items() {
            /*
             * commented code for integration with Request a Quote
            if ( !is_checkout() )
                return;

            if ( $this->check_cart_contents ) {
                // commented for prevent issue with Deposit Payment
         ...
         * @author Leanza Francesco <leanzafrancesco@gmail.com>
         */
        public function woocommerce_order_item_visible( $value, $cart_item ) {
            if ( !isset( $cart_item[ 'bundled_by' ] ) )
                return $value;
        ...
        public function enqueue_scripts() {
            ...
            $yith_wcpb = apply_filters( 'yith_wcpb_frontend_js_params', array(
                'price_handler' => '.summary p.price'
            ) );
            ...
            wp_localize_script( 'yith_wcpb_bundle_frontend_add_to_cart', 'yith_wcpb', $yith_wcpb );
