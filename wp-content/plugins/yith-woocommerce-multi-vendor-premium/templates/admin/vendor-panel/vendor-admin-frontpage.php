...
<div class="wrap yith-vendor-admin-wrap" id="vendor-details">
    <form method="post" action="admin.php" enctype="multipart/form-data">
        ...
        <div class="form-field contact-info">
            ...
            <label for="vendor_vat"><?php _e( 'VAT/SSN:', 'yith-woocommerce-product-vendors' ) ?></label>
            ...
            <br />
            <span class="description"><?php _e( 'The VAT/SSN of your store.', 'yith-woocommerce-product-vendors' ); ?></span>
