...
return array(
    ...
    'frontpage' => array(
        ...
        'frontpage_vendors_registration_vat' => array(
            'title' => __('VAT/SSN number', 'yith-woocommerce-product-vendors'),
            'type' => 'checkbox',
        ...
        'frontpage_header_skin' => array(
            ...
            'type' => 'select',
            'desc' => __('Skin 1: Black background and white font color, Skin 2: White background and black font color', 'yith-woocommerce-product-vendors'),
            'id' => 'yith_vendors_skin_header',
            'options' => array(
                'skin1' => __('Skin 1', 'yith-woocommerce-product-vendors'),
                'skin2' => __('Skin 2', 'yith-woocommerce-product-vendors'),
            ),
            'default' => 'skin1'
        ),
        ...
        'frontpage_header_show_gravatar_image' => array(
            ...
            'options' => array(
                'enabled' => __('Let vendors decide', 'yith-woocommerce-product-vendors'),
        ...
        'frontpage_vat' => array(
            'title' => __('Show VAT/SSN in store page', 'yith-woocommerce-product-vendors'),
            'type' => 'checkbox',
            'desc' => __('Select if you want to show the VAT/SSN information in the header of Store page.', 'yith-woocommerce-product-vendors'),
