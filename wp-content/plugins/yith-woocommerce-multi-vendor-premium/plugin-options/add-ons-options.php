...
return array(
	...
	'add-ons' => array(
		...
		'vendors_best_price_options' => array(
			'type' => 'sectionstart',
		),

		'vendors_best_price_options_title' => array(
			'title' => __( 'Best Price Guaranteed', 'yith-woocommerce-product-vendors' ),
			'type'  => 'title',
			'desc'  => YITH_Vendors()->addons->get_plugin_landing_uri( 'best-price', 'display' ),
			'id'    => 'yith_wpv_vendors_best_price_title',
		),

		'vendors_best_price_options_mode' => array(
			'title'             => __( 'Enable Best Price Guaranteed features for vendors', 'yith-woocommerce-product-vendors' ),
			'type'              => 'checkbox',
			'desc'              => YITH_Vendors()->addons->get_option_description( 'best-price' ),
			'id'                => 'yith_wpv_vendors_option_best_price_management',
			'default'           => 'no',
			'custom_attributes' => YITH_Vendors()->addons->has_plugin( 'best-price' ) ? false : array(
				'disabled' => 'disabled',
			),
		),

		'vendors_best_price_options_end' => array(
			'type' => 'sectionend',
		),
