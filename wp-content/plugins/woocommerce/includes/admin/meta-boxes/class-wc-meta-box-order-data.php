		...
		<div class="panel-wrap woocommerce">
			...
			<div id="order_data" class="panel">
				...
				if ( $post->post_parent > 0 ) {
					echo esc_html( sprintf( _x( '%s #TRIFUN-%s details', 'Order #123 details', 'woocommerce' ), $order_type_object->labels->singular_name, $order->post->post_parent ) );
				}?>
				<?php
				if ( $post->post_parent <= 0 ) {
					echo esc_html( sprintf( _x( '%s #TRIFUN-%s details', 'Order #123 details', 'woocommerce' ), $order_type_object->labels->singular_name, $order->get_order_number() ) );
				}?>
				</h2>
