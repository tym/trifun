...
class AW_Post_Types {
	...
	static function register_post_types() {
		register_post_type( AW()->post_type,
			apply_filters( 'automatewoo_register_post_type_' . AW()->post_type,
				array(
					'labels'              => array(
					...
					'description'         => __( 'This is where AutomateWoo Workflows are stored.', 'automatewoo' ),
					'public'              => false,
					'show_ui'             => true,
