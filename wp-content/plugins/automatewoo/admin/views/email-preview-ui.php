...
<html>
	...
	<head>
		...
		<script src="<?php echo AW()->admin_assets_url( '/js/automatewoo-email-preview.js?ver=' . AW()->version ) ?>"></script>
	...
	<div class="email-preview-container">
		<div class="email-preview-header">
			...
			<div class="email-preview-header-left">
				<div class="from"><strong><?php _e('From', 'automatewoo') ?>:</strong> <?php echo AW()->email->get_from_name( $template ) ?> &lt;<?php echo AW()->email->get_from_address( $template ) ?>&gt;</div>
