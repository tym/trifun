<?php
/**
 * @class AW_Dashboard_Widget_Chart_Abstract
 */

abstract class AW_Dashboard_Widget_Chart_Abstract extends AW_Dashboard_Widget_Abstract {
	...
	function prepare_chart_data( $data, $date_key, $data_key, $interval, $group_by ) {
		...
		$prepared_data = [];
		$start_date = strtotime( get_date_from_gmt( $this->date_from->format( 'Y-m-d H:i:s' ) ) );
