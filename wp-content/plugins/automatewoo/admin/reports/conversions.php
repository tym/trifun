<?php
/**
 * @class		AW_Report_Conversions
 * @package		AutomateWoo/Admin/Reports
 */

class AW_Report_Conversions extends AW_Report_Abstract_Graph
{
	/** @var array  */
	...
	public $conversion_orders = array();
	...
	function load_chart_data()
	{
		...
		foreach ( $orders->posts as $order_id )
		{
			...
			$order_obj->date = $order->post->post_date;
