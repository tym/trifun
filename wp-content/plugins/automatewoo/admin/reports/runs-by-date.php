<?php
/**
 * @class AW_Report_Runs_By_Date
 */

class AW_Report_Runs_By_Date extends AW_Report_Abstract_Graph
{
	/** @var array  */
	...
	public $workflow_ids = array();
	public $workflow_ids_titles = array();
	...
	function get_chart_legend()
	{
		...
		$legend[] = array(
			'title' => sprintf( __( '%s workflows have run for the selected period', 'woocommerce' ), '<strong>' . $this->logs_count . '</strong>' ),
