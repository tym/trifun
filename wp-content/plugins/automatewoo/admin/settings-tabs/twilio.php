<?php
/**
 * @class 		AW_Settings_Tab_Twilio
 */

class AW_Settings_Tab_Twilio extends AW_Admin_Settings_Tab_Abstract {
	...
	function get_settings() {
		return [
			...
			[
				...
				'desc'     =>  __( 'Must be a Twilio phone number (in E.164 format) or alphanumeric sender ID.', 'automatewoo' ),
	...
	function output() {
		...
		AW()->admin->get_view('sms-test-twilio');

		wp_enqueue_script('automatewoo-sms-test');
	}
}

return new AW_Settings_Tab_Twilio();
