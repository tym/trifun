...
<table class='yith-wcmbs-membership-table'>
    ...
    foreach ( $posts as $value ) {
        if ( is_numeric( $value ) ) {
            ...
            <tr>
                <td class="yith-wcmbs-membership-table-icon"><?php echo $icon ?></td>
                <td class="yith-wcmbs-membership-table-title"><?php echo $title . $availability ?></td>
                <td class="yith-wcmbs-membership-table-download"><?php echo $download ?></td>
            </tr>
