 ...
 * Plugin URI: http://yithemes.com/themes/plugins/yith-woocommerce-membership
...
if ( !defined( 'YITH_WCMBS_VERSION' ) ) {
    define( 'YITH_WCMBS_VERSION', '1.2.8' );
}
...
function yith_wcmbs_pr_init() {
    ...
    require_once( 'includes/class.wc-shipping-membership-free-shipping.php' );
    ...
    require_once( 'class.yith-wcmbs-frontend-premium.php' );
    require_once( 'class.yith-wcmbs-admin.php' );
    require_once( 'class.yith-wcmbs-admin-premium.php' );
