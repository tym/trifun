...
if ( !class_exists( 'YITH_WCMBS_Expiring_Mail' ) ) :
    ...
    class YITH_WCMBS_Expiring_Mail extends WC_Email {
        ...
        function __construct() {
            ...
            // Other settings
            $this->custom_message = $this->get_option( 'custom_message', __( 'Dear Customer {firstname} {lastname}, your membership {membership_name} will expire on {membership_expire_date}.', 'yith-woocommerce-membership' ) );
        ...
        public function init_form_fields() {
            $this->form_fields = array(
                ...
                'custom_message' => array(
                    ...
                    'placeholder' => '',
                    'default'     => __( 'Dear Customer {firstname} {lastname}, your membership {membership_name} will expire on {membership_expire_date}.', 'yith-woocommerce-membership' )
                ),
                'email_type'     => array(
