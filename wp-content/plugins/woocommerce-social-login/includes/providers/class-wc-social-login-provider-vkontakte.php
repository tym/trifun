...
class WC_Social_Login_Provider_VKontakte extends WC_Social_Login_Provider {
	...
	public function __construct( $base_auth_path ) {
		...
		$this->notices = array(
			...
			'account_unlinked'       => __( 'VK account was successfully unlinked from your account.', 'woocommerce-social-login' ),
	...
	public function get_description() {
		...
		return sprintf( __( 'Need help setting up and configuring VK? %sRead the docs%s', 'woocommerce-social-login' ), '<a href="http://docs.woothemes.com/document/woocommerce-social-login-create-social-apps#vk">', '</a>' );
	}
