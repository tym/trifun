...
SV_WC_Framework_Bootstrap::instance()->register_plugin( '4.4.0', __( 'WooCommerce Social Login', 'woocommerce-social-login' ), __FILE__, 'init_woocommerce_social_login', array(
...
class WC_Social_Login extends SV_WC_Plugin {
	 ...
	 *
	 * @TODO Remove this as part of WC 2.7 compat {TZ 2016-05-22}
	 *
	 * @since 1.8.0
	 */
	public function &__get( $name ) {
		...
		switch ( $name ) {
			...
			case 'admin':
				...
				_deprecated_function( 'wc_social_login()->admin', '1.8.0', 'wc_social_login()->get_admin_instance()' );
				return $this->get_admin_instance();

			case 'frontend':

				/* @deprecated since 1.8.0 */
				_deprecated_function( 'wc_social_login()->frontend', '1.8.0', 'wc_social_login()->get_frontend_instance()' );
