...
<div class="row">
	<div class="large-10 text-center large-centered columns">
		...
		<p class="return-to-shop"><a class="wc-backward" href="<?php echo home_url() . '/buy-membership'; ?>"><?php _e( 'Return To Shop', 'woocommerce' ) ?></a></p>

	</div><!-- .large-10    <?php echo get_permalink( wc_get_page_id( '308' ) ); ?> -->
</div><!-- .row-->